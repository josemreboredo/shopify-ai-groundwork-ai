 ...
 */
export function prepare({ questionnaire, client, workRoot = path.join(REPO_ROOT, 'clients', '.work'), today }) {
 ...
 */
export function finishWork({ workDir, outDir = path.join(REPO_ROOT, 'clients'), dryRun = false }) {
