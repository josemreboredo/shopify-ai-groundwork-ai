...
3. Managing markets — https://help.shopify.com/en/manual/markets/getting-started/managing-markets — "Customizing catalogs for use with retail markets requires Shopify POS Pro or the Plus plan." — checked 2026-09-17
4. International domains — https://help.shopify.com/en/manual/international/managing-international-domains — "region-specific URLs benefit from your store's existing search ranking and domain authority" — checked 2026-09-17
...
6. Languages — https://help.shopify.com/en/manual/international/localization-and-translation — "You can sell in up to 20 languages from a single Shopify store on the Basic, Grow, Shopify, or Advanced plan, and in up to 30 languages on the Shopify Plus plan" — checked 2026-09-17
...
9. Pricing for markets — https://help.shopify.com/en/manual/international/pricing — "if you sell in local currencies, then you need to have a country selector so that customers can select their local country or region" — checked 2026-09-17
