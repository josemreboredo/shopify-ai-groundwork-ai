...
- **Tier:** T4 · **Date:** 2026-09-17 · **ADR:** [0008](../../../docs/adr/0008-interview-surface-and-session.md)
- **Validation plan:** [`discovery/docs/validation/interview-chatbot-validation.md`](../validation/interview-chatbot-validation.md)
...
────────────────────────────────────           ──────────────────────────────────
converse in the person's language   ──CLI──►   discovery/agents/interview/
...
- The value is written into a copy of the answers, the engagement envelope is assembled and validated against
  `contracts/engagement.schema.json`; errors for that pointer are returned and nothing is saved.
