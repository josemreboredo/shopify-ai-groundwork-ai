...
- **Scope:** `discovery/agents/discovery/` (Phase 2) · **Tier:** T3 (runtime LLM, client data) · **Date:** 2026-09-16
...
| Offer rules, modifiers, price adds (`discovery/schema/offering.json`) | Confidential — Merkle internal |
...
Covered by `discovery/tests/unit/discovery-engine.test.js`: consent refusal without model calls; redaction and
