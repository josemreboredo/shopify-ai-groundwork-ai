 ...
 */
const DATA_OWNERSHIP = 'Default data ownership: product content, attributes and media come from the PIM (or are maintained in Shopify when there is no PIM); prices, inventory, orders and financials come from the ERP. Confirm any deviation with the client in the field mapping.';
