...
const PLAN_RANK = { none: 0, starter: 1, retail: 1, basic: 2, grow: 3, advanced: 4, plus: 5, enterprise: 6 };
...
export const PLAN_RULES = [
  ...
  { feature: 'checkout UI extensions on the information, shipping or payment steps / Checkout Branding API', plan: 'plus', docs: `${H}checkout-settings/customize-checkout-configurations`, inputs: ['/checkout/customisation'],
    applies: (d) => has(d.checkout?.customisation, 'checkout_step_blocks_or_fields', 'checkout_branding_api_styling') },
  { feature: 'expansion stores', plan: 'plus', docs: `${H}organization-settings/expansion-stores`, inputs: ['/markets/topology/recommendation'],
    applies: (d) => ['expansion_stores', 'hybrid'].includes(d.markets?.topology?.recommendation) },
  ...
  { feature: 'more than 20 published languages', plan: 'plus', docs: `${H}international/localization-and-translation`, inputs: ['/markets/list'],
