 ...
 *
 * @module bid/clarifications
 */

import { questionBank } from '../schema/index.js';
import { answeredQuestions } from '../engine/knowledge.js';
import { questionApplies } from '../engagement/next.js';
import { runCostFor, basis } from '../engine/economics.js';
import { writeInLanguage } from '../shared/language.js';
