...
9. Bulk import data (GraphQL Admin API) — https://shopify.dev/docs/apps/build/apis/graphql-admin/bulk-operations/imports — "The size of the JSONL file can't exceed 100MB." — checked 2026-09-17
...
14. Migrating clients to Shopify from another platform — https://help.shopify.com/en/partners/manage-clients-stores/migrating-clients — "you can use a third-party store data importer app such as Matrixify to import their customer, product, and order records" — checked 2026-09-17
