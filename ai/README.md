...
| Offer, scope gates, exit rules, Shopify plan, app signals | code (`engine/`) | inside `engagement.json` |
...
| Folder | Contents |
|---|---|
| `engine/` | Engine: extraction, classification, exit rules, plan benchmark, app signals, approach, rendering |
