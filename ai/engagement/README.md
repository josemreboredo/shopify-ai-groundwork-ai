...
Architecture: [`ai/docs/architecture/interview-chatbot.md`](../docs/architecture/interview-chatbot.md) ·
validation plan: [`ai/docs/validation/interview-chatbot-validation.md`](../docs/validation/interview-chatbot-validation.md).
...
(`ai/tests/unit/interview.test.js`) include parity: the same answers through the interview and through the
