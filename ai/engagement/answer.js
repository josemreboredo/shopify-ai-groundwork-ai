...
import { assembleAnswers, flattenAnswers, toSchemaPointer } from '../engine/extract.js';
import { COMPUTED_POINTERS } from '../engine/extraction-schema.js';
 ...
 * @returns {string[]}
 */
function answerErrors(answers, session, today) {
