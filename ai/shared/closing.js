 ...
 *
 * @module ai/shared/closing
 */

import Ajv2020 from 'ajv/dist/2020.js';

import { flattenAnswers, processExtraction } from '../engine/extract.js';
import { answerValidator, decide, finalize, needsApproach, stopRoute } from '../engine/engine.js';
import { APPROACH_SYSTEM, approachInput, approachQualityErrors, fromApproachPayload } from '../engine/approach.js';
import { buildApproachSchema } from '../engine/extraction-schema.js';
import { buildDeckXml } from '../discovery-deck/build.js';
import { knowledgeFor } from '../engine/knowledge.js';
import { ServiceError } from './errors.js';
import { runCostFor } from '../engine/economics.js';
import { challengesFor, topChallenges } from '../engine/challenge.js';
import { writeInLanguage } from './language.js';
import { DECK_PROMPT } from '../discovery-deck/prompt.js';
import { selectStories, summariseByEpic } from '../backlog/select.js';
 ...
 *
 * @param {import('../engagement/session.js').Session} session
 * @param {string} today
