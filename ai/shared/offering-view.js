...
const APPROACH = {
  ...
  L: {
    storefront: 'A Shopify theme built out template by template over one token layer; a headless Hydrogen storefront on Oxygen as an add-on where the answers ask for one',
