 ...
 * model as evidence, with App Store candidates from discovery/schema/apps.json) and by
...
const AUTO_TRANSLATED_LANGUAGES = 2;
 ...
 * `shopify.apps` of questions that feed the area, from discovery/schema/apps.json. An app
