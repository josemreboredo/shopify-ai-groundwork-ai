...
`ai/tests/unit/discovery-rules.test.js` (gates, offer, exit rules against the golden fixtures) and
`ai/tests/unit/discovery-engine.test.js` (full pipeline with recorded LLM responses — no network).
Threat model: [`ai/docs/architecture/discovery-engine-threat-model.md`](../docs/architecture/discovery-engine-threat-model.md).
