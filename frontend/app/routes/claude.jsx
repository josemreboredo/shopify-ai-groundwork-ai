...
export const meta = () => [{ title: 'Claude Project · Merkle Discovery' }];
  ...
  return (
    <main>
      ...
      <ol>
        ...
        <li>Name: <code>Merkle Discovery</code> · MCP server URL: <code>{url}</code></li>
      ...
      <ol>
        ...
        <li>In a chat in the Project, enable <strong>Merkle Discovery</strong> under <strong>+ → Connectors</strong> and ask Claude to process the documents.</li>
      </ol>
