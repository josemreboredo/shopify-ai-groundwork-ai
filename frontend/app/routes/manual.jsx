    ...
    <main className="manual">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>“This engagement is beyond the standard offers”</td><td>Nothing has stopped. The requirements go past S/M/L, so decide with your lead how Merkle proceeds and answer Q10.5.5 — the page links straight to it. <strong>Larger Engagement</strong> means a full, consultant-led Discovery Phase: the client deck is still produced and shared, the Jira backlog is not, because it is defined during that phase. <strong>No bid</strong> means Merkle does not propose.</td></tr>
