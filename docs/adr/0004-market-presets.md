...
2. Market knowledge lives in presets: `build/lwc-library/swiss-baseline/` becomes the first preset
...
- `build/lwc-library/README.md` describes swiss-baseline as a preset, not the baseline for all clients.
